 ...
 *
 * <P>
 * To keep you safe by default, WEB4J goes to some effort to escape characters
 ...
 * shouldn't need to <em>directly</em> use the services of this class very
 * often.  *
 * <P>
 * <span class='highlight'>For Model Objects containing free form user input, it
 * is highly recommended that you use {@link SafeText}, not
 * <tt>String</tt></span>. Free form user input is open to malicious use, such
 * as
 * <a href='http://www.owasp.org/index.php/Cross_Site_Scripting'>Cross Site
 * Scripting</a>
 ...
 * method.  *
 * <P>
 * The following WEB4J classes will automatically escape special characters for
 * you, when needed :
 * <ul>
...
public final class EscapeChars {
     ...
     * @param aText Insensitive to case.
     * @return 
     */
    ...
    /**
     * Fix the provided string to add scape character for sql
     * @param str
     * @return 
     */
...
//		ESAPI.encoder().encodeForSQL( ORACLE_CODEC, );
    ...
    /**
     * Fix the scape characters for a javascript parameter
     *
     * @param str parameter to fix
     * @return the string provided with scape characters appended to " chars
     */
