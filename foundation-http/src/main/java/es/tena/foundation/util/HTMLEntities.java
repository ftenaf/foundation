 ...
 * HTML entitities and vice versa.<br/><br/>
 ...
 *
 * @author Nicola Asuni [www.tecnick.com]. Revised by Francisco Tena
 * (francisco.tena@gmail.com)
 * @version 1.0.004
 */
public class HTMLEntities {
    ...
    /**
     * Gets a String array from a table tag in a html
     * @param html
     * @return 
     */
    public static String[][] getTableData(String html){
        String[][] trtd = null;
        ...
        for (Element table : tables) {
            ...
            for (int i = 0; i < trs.size(); i++) {
                ...
                for (int j = 0; j < tds.size(); j++) {
                    ...
                    System.out.println("["+i+ "]["+j+"] "+trtd[i][j]);
                }
            }
        }
        return trtd;
