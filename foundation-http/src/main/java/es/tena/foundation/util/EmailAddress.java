...
public class EmailAddress implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2441016598867312634L;

	private static final boolean ALLOW_DOMAIN_LITERALS = true;

	/**
	 * * This contstant states that quoted identifiers are allowed * (using
	 * quotes and angle brackets around the raw address) are allowed, e.g.: * *
	 * <p>
	 ...
	 * <p>
	 * Its default value is <tt>true</tt> to remain RFC 2822 compliant, but *
